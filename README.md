...
Reaction type: 
Specify the type of reaction.  Although EStokTP can accept abstraction, addition, isomerization, and beta-scission, currently TorsScan can only generate the input for abstractions. Default is blank, which means that the job is a well.
...
Use QTC xyz: gaussian/b3lyp/6-31g*
...
Checking, editing, and adding input parameters
You can check, edit, and specific keywords in the ARGS object in torsional_scan.py (def get_options is currently line 526).  If you change them, though, please edit this document and the example input.dat in the TorsScan directory to reflect your change.  Users can ask about or request additional input parameters by emailing Sarah Elliott.
